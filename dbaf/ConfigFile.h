#ifndef DBAF_CONFIG_FILE_H
#define DBAF_CONFIG_FILE_H
...
class DBAFLUAExecutionState
{
private:
public:
  static const char className[];
  static Lunar<DBAFLUAExecutionState>::RegType methods[];
  DBAFLUAExecutionState();
  DBAFLUAExecutionState(lua_State *L);
  ~DBAFLUAExecutionState();
